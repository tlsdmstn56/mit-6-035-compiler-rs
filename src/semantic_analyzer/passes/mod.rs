...
// [x] 6. 	 If a method call is used as an expression, the method must return a result.
...
// [x] 10. For all locations of the form <id>[<expr>]
...
// ----------------------------------------/
// check after IR construction: type check  
// ----------------------------------------/
